...
3. Bygg nästa ELF-lager ovanpå callback/trace-flödet: fler libc-lika callback-op:s (`snprintf`-shim, `strtod`, `sscanf`-shim), bättre argument/retur-semantik och preset-profiler per app/lib.
