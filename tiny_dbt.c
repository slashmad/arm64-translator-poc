...
static bool parse_elf_import_callback_kind(const char *kind, uint8_t *out_callback_id) {
    ...
    if (strcmp(kind, "guest_strrchr_x0_x1") == 0) {
        *out_callback_id = IMPORT_CB_GUEST_STRRCHR_X0_X1;
        return true;
    }
    if (strcmp(kind, "guest_strstr_x0_x1") == 0) {
        *out_callback_id = IMPORT_CB_GUEST_STRSTR_X0_X1;
        return true;
    }
    if (strcmp(kind, "guest_memchr_x0_x1_x2") == 0) {
        *out_callback_id = IMPORT_CB_GUEST_MEMCHR_X0_X1_X2;
        return true;
    }
    if (strcmp(kind, "guest_memrchr_x0_x1_x2") == 0) {
        *out_callback_id = IMPORT_CB_GUEST_MEMRCHR_X0_X1_X2;
        return true;
    }
    if (strcmp(kind, "guest_atoi_x0") == 0) {
        *out_callback_id = IMPORT_CB_GUEST_ATOI_X0;
        return true;
    }
    if (strcmp(kind, "guest_strtol_x0_x1_x2") == 0) {
    ...
    if (strcmp(kind, "guest_strtod_x0_x1") == 0) {
        *out_callback_id = IMPORT_CB_GUEST_STRTOD_X0_X1;
        return true;
    }
    if (strcmp(kind, "guest_sscanf_x0_x1_x2") == 0) {
        *out_callback_id = IMPORT_CB_GUEST_SSCANF_X0_X1_X2;
        return true;
    }
    if (strcmp(kind, "guest_vsnprintf_x0_x1_x2_x3") == 0) {
        *out_callback_id = IMPORT_CB_GUEST_VSNPRINTF_X0_X1_X2_X3;
        return true;
    }
    if (strcmp(kind, "guest_vsscanf_x0_x1_x2") == 0) {
        *out_callback_id = IMPORT_CB_GUEST_VSSCANF_X0_X1_X2;
        return true;
    }
    if (strcmp(kind, "guest_vsnprintf_chk_x0_x1_x4_x5") == 0) {
    ...
    if (strcmp(kind, "guest_strtoul_x0_x1_x2") == 0) {
        *out_callback_id = IMPORT_CB_GUEST_STRTOUL_X0_X1_X2;
        return true;
    }
    if (strcmp(kind, "guest_posix_memalign_x0_x1_x2") == 0) {
...
static const char *import_callback_kind_name(uint8_t callback_id) {
    switch (callback_id) {
        ...
        case IMPORT_CB_GUEST_STRRCHR_X0_X1:
            return "guest_strrchr_x0_x1";
        case IMPORT_CB_GUEST_STRSTR_X0_X1:
            return "guest_strstr_x0_x1";
        case IMPORT_CB_GUEST_MEMCHR_X0_X1_X2:
            return "guest_memchr_x0_x1_x2";
        case IMPORT_CB_GUEST_MEMRCHR_X0_X1_X2:
            return "guest_memrchr_x0_x1_x2";
        ...
        case IMPORT_CB_GUEST_STRTOD_X0_X1:
            return "guest_strtod_x0_x1";
        case IMPORT_CB_GUEST_SSCANF_X0_X1_X2:
            return "guest_sscanf_x0_x1_x2";
        case IMPORT_CB_GUEST_VSNPRINTF_X0_X1_X2_X3:
            return "guest_vsnprintf_x0_x1_x2_x3";
...
static bool apply_elf_import_preset(CliOptions *opts, const char *preset) {
    static const struct {
        ...
        {"strtoul", IMPORT_CB_GUEST_STRTOUL_X0_X1_X2},
        {"strtoull", IMPORT_CB_GUEST_STRTOUL_X0_X1_X2},
    ...
    static const struct {
        ...
        {"pthread_mutex_init", IMPORT_CB_RET_0},
        {"pthread_mutex_destroy", IMPORT_CB_RET_0},
        ...
        {"__system_property_get", IMPORT_CB_RET_0},
        {"closedir", IMPORT_CB_RET_0},
    ...
    static const struct {
        ...
        {"strtoll_l", IMPORT_CB_GUEST_STRTOL_X0_X1_X2},
        {"strtoull_l", IMPORT_CB_GUEST_STRTOUL_X0_X1_X2},
        {"strtold_l", IMPORT_CB_GUEST_STRTOD_X0_X1},
        ...
        {"AAssetManager_fromJava", IMPORT_CB_RET_SP},
        {"AAssetManager_open", IMPORT_CB_RET_SP},
        {"AAsset_open", IMPORT_CB_RET_SP},
        {"AAsset_close", IMPORT_CB_RET_0},
        {"AAsset_getLength64", IMPORT_CB_RET_1},
        {"AAsset_openFileDescriptor64", IMPORT_CB_RET_1},
        {"AAsset_read", IMPORT_CB_RET_1},
        {"AAsset_seek", IMPORT_CB_RET_1},
        {"freeaddrinfo", IMPORT_CB_RET_0},
        {"__stack_chk_guard", IMPORT_CB_RET_SP},
        {"__strncpy_chk2", IMPORT_CB_GUEST_STRNCPY_X0_X1_X2},
        {"__read_chk", IMPORT_CB_RET_1},
        {"__strcpy_chk", IMPORT_CB_GUEST_STRCPY_X0_X1},
        {"_ctype_", IMPORT_CB_RET_SP},
        {"acos", IMPORT_CB_RET_0},
        ...
        {"feof", IMPORT_CB_RET_0},
        {"fgetpos", IMPORT_CB_RET_0},
        {"fseeko", IMPORT_CB_RET_0},
        {"fsetpos", IMPORT_CB_RET_0},
        {"fsync", IMPORT_CB_RET_0},
        {"ftello", IMPORT_CB_RET_1},
        ...
        {"isalnum", IMPORT_CB_RET_0},
        {"isalpha", IMPORT_CB_RET_0},
        {"iswalpha", IMPORT_CB_RET_0},
        {"iswblank", IMPORT_CB_RET_0},
        {"iswcntrl", IMPORT_CB_RET_0},
        {"iswdigit", IMPORT_CB_RET_0},
        {"iswlower", IMPORT_CB_RET_0},
        {"iswprint", IMPORT_CB_RET_0},
        {"iswpunct", IMPORT_CB_RET_0},
        {"iswspace", IMPORT_CB_RET_0},
        {"iswupper", IMPORT_CB_RET_0},
        {"iswxdigit", IMPORT_CB_RET_0},
        {"listen", IMPORT_CB_RET_0},
        {"localeconv", IMPORT_CB_RET_SP},
        {"localtime", IMPORT_CB_RET_SP},
        {"mktime", IMPORT_CB_RET_1},
        {"optarg", IMPORT_CB_RET_SP},
        {"optind", IMPORT_CB_RET_0},
        {"perror", IMPORT_CB_RET_0},
        {"pthread_mutex_trylock", IMPORT_CB_RET_0},
        {"pthread_mutexattr_destroy", IMPORT_CB_RET_0},
        {"pthread_mutexattr_init", IMPORT_CB_RET_0},
        ...
        {"siglongjmp", IMPORT_CB_RET_0},
        {"strcspn", IMPORT_CB_RET_0},
        {"strtok_r", IMPORT_CB_RET_X0},
        {"vsprintf", IMPORT_CB_RET_0},
